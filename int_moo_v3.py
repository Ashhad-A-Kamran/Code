    ...
    def train(self):
        try:
            ...
            for epoch in range(self.total_epochs):
                ...
                # Energy Efficiency Proxy (L2 weight penalty as a placeholder for complexity/energy)
                # Combined with real energy draw feedback if available
        ...
        async def receive_command(cmd: CmdModel):
            if cmd.model_id in self.trainers:
                ...
                if cmd.command in ["pause_training", "resume_training"]:
                    ...
                    t.queues[CONTROL_TYPE].put(cmd.model_dump())
